...
const RoomDeleteConfirmation = ({toggleDeleteConfirm, handleDelete}) => {
  return (
    <div className='fixed inset-0 z-20 flex items-center justify-end'>
        <div className='absolute top-0 left-0 z-20 flex items-center justify-center w-full h-screen backdrop-blur bg-black/60'>
